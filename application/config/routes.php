...
$route['peminjaman-user'] = 'peminjaman_user';
$route['peminjaman-user-create'] = 'peminjaman_user/create';
$route['pengembalian-user'] = 'pengembalian_user';
$route['laporan-buku'] = 'laporan/laporan_buku';
$route['cetak-laporan-buku'] = 'laporan/cetak_laporan_buku';
$route['laporan-anggota'] = 'laporan/laporan_anggota';
$route['cetak-laporan-anggota'] = 'laporan/cetak_laporan_anggota';
